...
# requests ile html kaynağını alınıp, beautifulsoup ile yorumlandı.
# anasayfadaki kurs listesi.
# kurs resmi, kurs başlığı, açıklama, udemy_link,site_link
# kurs bilgilerini kurslar.csv dosyasına kayıt işlemi gerçekleştirildi.
